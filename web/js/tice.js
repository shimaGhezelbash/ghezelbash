...
function previewSmsListToAll() {
    new jj("do=Tice_term.previewSmsListToAll&text=" + (new jj("#tice_term_sms").jjVal())).jjAjax2(true);
}
function previewSmsListTermStudent(id) {
    new jj("do=Tice_term.previewSmsListTermStudent&id=" + id + "&text=" + (new jj("#tice_term_sms").jjVal())).jjAjax2(true);
}
function previewSmsListTermTeacher(id) {
    new jj("do=Tice_term.previewSmsListTermTeacher&id=" + id + "&text=" + (new jj("#tice_term_sms").jjVal())).jjAjax2(true);
}
function sendSmsTerm() {
    new jj("do=Tice_term.sendSms&Numbers=" + (new jj("#receiver_number").jjVal()) + "&text=" + (new jj("#note").jjVal())).jjAjax2(true);
}
function previewSmsTeacher(id) {
    new jj("do=Tice_teacher.previewSms&id=" + id + "&text=" + (new jj("#ticeTeachers_Extra2").jjVal())).jjAjax2(true);
}
function sendSmsTeacher() {
    new jj("do=Tice_teacher.sendSms&Numbers=" + (new jj("#receiver_number").jjVal()) + "&text=" + (new jj("#note").jjVal())).jjAjax2(true);
}
function previewSmsBedehkar(termid) {
    new jj("do=Tice_report.previewSmsBedehkar&txt1=" + (new jj("#smsBedehkartxt1").jjVal())+"&txt2="+(new jj("#smsBedehkartxt2").jjVal()) + "&term=" + termid).jjAjax2(true);
}
function sendSmsBedehkar() {//a table 
    new jj("do=Tice_report.sendSmsInCheckList&" + (new jj("#previewSMSbedehkarDiv").jjSerial())).jjAjax2(true);
}
function previewSmsExelentStd(termid) {
    new jj("do=Tice_report.previewSmsExelentStd&txt=" + (new jj("#smsExelentStdtxt").jjVal())+ "&term=" + termid).jjAjax2(true);
}
function sendSmsExelentStds() {//a table 
    new jj("do=Tice_report.sendSmsInCheckList&" + (new jj("#previewExelentStdsDiv").jjSerial())).jjAjax2(true);
}
function previewSmsPassedStd(termid) {
    new jj("do=Tice_report.previewSmsPassedStd&txt=" + (new jj("#smsPassedStdstxt").jjVal())+ "&term=" + termid).jjAjax2(true);
}
function sendSmsPassedStds() {//a table 
    new jj("do=Tice_report.sendSmsInCheckList&" + (new jj("#previewPassedStdsDiv").jjSerial())).jjAjax2(true);
}
function previewSmsMashrootStds(termid) {
    new jj("do=Tice_report.previewSmsMashrootStds&txt=" + (new jj("#smsMashrootStdstxt").jjVal())+ "&term=" + termid).jjAjax2(true);
}
function sendSmsMashrootStds() {//a table 
    new jj("do=Tice_report.sendSmsInCheckList&" + (new jj("#previeMashrootStdsDiv").jjSerial())).jjAjax2(true);
}
function previewSmsMardoodStds(termid) {
    new jj("do=Tice_report.previewSmsMardoodStds&txt=" + (new jj("#smsMardoodStdstxt").jjVal())+ "&term=" + termid).jjAjax2(true);
}
function sendSmsMardoodStds() {//a table 
    new jj("do=Tice_report.sendSmsInCheckList&" + (new jj("#previeMardoodStdsDiv").jjSerial())).jjAjax2(true);
}
...
function serialClassActivity() {
    if(new jj('#dateInClassActivityForTeacher').jjVal().length == 0) {
        ...
        $("#submitClassActivitiesBtn").prop('disabled','disabled'); //disable further clicks
...
function printAllRezerv(){
    jj('Print?form=printAllRezerv&id=1').jjGoNewPage();
}
function printAllFreeTime(){
    jj('Print?form=printAllFreeTime&id=2').jjGoNewPage();
}
function printAllEteraz(){
    jj('Print?form=printAllEteraz&id=3').jjGoNewPage();
}
...
function signOutTice(){
    ...
    $("#jjLoginExitPanel").html('ورود (دانشجویان و اساتید)');
    $("#studentPanel").hide();
    $("#teacherPanel").hide();
    $("#downloadPanel").hide();
...
function showSMSFormTice(numbers,body,sum){
    if($('#pshowSMSFormDiv').length==0){
        $("body").append("<div id='pshowSMSFormDiv'></div>");
        $("#pshowSMSFormDiv").load("formTice/sms_tice_list.html", null, function(){            
            $("#receiver_number").val(numbers);
            $("#note").val(body);
            $("#sumOfsms").html(sum);
            $('#SendSMSBtn').button().click(function(){
                tice_class_list.sendSmsClass(); 
            });
...
//    new jj("do=Tice_Student.voteToPoll&id="+id+"&text="+(new jj("#ticeClass_comment").jjVal())).jjAjax2(true);
}
function sendEmailClass(){
    new jj("do=Tice_class.SendEmail&id="+(new jj("#ticeClass_id").jjVal())+"&text="+(new jj("#ticeClass_comment").jjVal())).jjAjax2(true);
}
function sendEmailTerm(){
    new jj("do=Tice_term.SendEmail&id="+(new jj("#tice_term_id").jjVal())+"&text="+(new jj("#tice_term_des").jjVal())).jjAjax2(true);
}
