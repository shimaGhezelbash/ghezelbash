...
//                    }
    ...
    public DefaultTableModel getTableRowCount(String tableName) {
        DefaultTableModel otherSelect;
        try {
            otherSelect = otherSelect("SELECT COUNT(*) FROM" + tableName);
//                    if (otherSelect == null) {
//                        return Select(tableName, "id=" + 1);
//                    }
//                    if (otherSelect.getRowCount() > 0) {
...
//==============================================================================
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement ps = db.connection.prepareStatement("SELECT * FROM std_info");
        ResultSet result = ps.executeQuery();
        while (result.next()) {
            System.out.println(result.getString(1) + " " + result.getString(2));
        }
        DefaultTableModel dtm = db.otherSelect("SELECT * FROM std_info  WHERE std_info_stdNumber = '1' AND std_info_nationalCode = '1'");
